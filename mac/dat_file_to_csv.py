'''
    GiBUU: read (output) dat file and plug it into a csv file...
...
parser.add_argument('-path','--path', default='/Users/erezcohen/Desktop/GiBUU/release2017/Ntransparency/', type=str )
